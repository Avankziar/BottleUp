...
public class BottleUpCommandExecutor implements CommandExecutor
{
	private BottleUp plugin;
	private static CommandConstructor cc;
	
	public BottleUpCommandExecutor(BottleUp plugin, CommandConstructor cc)
	{
		this.plugin = plugin;
		BottleUpCommandExecutor.cc = cc;
	}
	...
	public void baseCommands(final Player player, int page)
	{
		...
		pastNextPage(player, BottleUp.infoCommandPath, page, lastpage, BottleUp.infoCommand);
	}
